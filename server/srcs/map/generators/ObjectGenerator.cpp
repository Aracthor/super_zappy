...
// Last Update Tue Oct 28 14:02:13 2014 
//
...
{
  (*probabilities)[Hoopla::taiga][Hoopla::shrub] = 10;
  (*probabilities)[Hoopla::taiga][Hoopla::saplin] = 10;
  (*probabilities)[Hoopla::taiga][Hoopla::maple] = 5;

  (*probabilities)[Hoopla::shrubland][Hoopla::shrub] = 20;
  ...
  (*probabilities)[Hoopla::temperate_jungle][Hoopla::maple] = 2;

  (*probabilities)[Hoopla::temperate_forest][Hoopla::shrub] = 3;
  ...
  (*probabilities)[Hoopla::temperate_forest][Hoopla::maple] = 1;
  ...
  (*probabilities)[Hoopla::tropical_forest][Hoopla::shrub] = 2;
  (*probabilities)[Hoopla::tropical_forest][Hoopla::bush] = 5;
